...
showModal8 : function()
{
  ...
  for(var i=0;i<5;i++)
  {
    ...
    else if(l==5 && (input_answer1.value == '0.8' || is_ans_true == true))
    {
      this.showModal1();
...
division : function(a,b,c,d)
 {
  ...
  {
    var cd = "";
    var sumineachplate = [0,0,0,0,0,0];
    var weightinplate = [];
  ...
  console.log("a : " + splitted_text[0] );
  console.log("b :" + splitted_text[1] );
  var is_ans_true = this.division(splitted_text[0],splitted_text[1],5,6);
  var k1=0; // counter variable for weightinplate data collection
  ...
  for(var i=0;i<6;i++)
  {
    ...
    else if(l == 6 && (input_answer1.value == '5/6' || is_ans_true == true))
    {
      this.showModal1();
    }
    else if(l==6 && (input_answer1.value == '0.8333' || is_ans_true == true))
    {
      this.showModal1();

    }
    else if( l==6 && (input_answer1.value!=='5/6' || is_ans_true == false))
    {
      this.showModal2();
    }
    else if( l!==6 && (input_answer1.value == '5/6' || is_ans_true == true))
