 ...
 playGame.prototype = 
 {
  ...
  create : function()
  {
   ...
   question_text_upper = game.add.text(185,10,'3 కేకులను నలుగురు (4) పిల్లలకు పంచడం లో    జమునికి సహాయం చేయండి.',style);
   ...
   question_text_instruction11 = game.add.text(20,525,'మీ జవాబుని పూర్ణ సంఖ్య లేదా భిన్నం రూపంలో నమోదు చేయండి మరియు మీ జవాబు సరైందో కాదో చూసుకొనుటకు                       క్లిక్ చేయండి.',style4);
  ...
  //question_text_instruction11.wordWrapWidth = 1600;
   ...
   answer_text1 = game.add.text(100,557,'కేక్.',style);
   ...
   instruction_text = game.add.text(24,384,'కేకుని చిన్న ముక్కలుగా కోయడానికి                         ఉపయోగించండి మరియు ఒక్కో పిల్ల వానికి ముక్కలు డ్రాగ్ చేసి మరియు డ్రాప్  చేయండి',style2);
