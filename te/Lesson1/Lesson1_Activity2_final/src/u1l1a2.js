 ...
 playGame.prototype =
 {
  ...
  create : function()
  {
   ...
   question_text_upper = game.add.text(120,2,'8 మంది పిల్లలను 2 సమాన సమూహాలుగా విభజించడంలో మరియు 12 కేకులు 2 సమూహాలలో సమానంగా  పంచడానికి జమునికి సహాయపడండి.   తద్వారా ఒక్కో పిల్లవాడు కేకు యొక్క సమానమైన వాటా పొందగలరు.',style);
   ...
   var question_instructs = game.add.text(125, 35, '1. పిల్లలను రెండు సమాన సమూహాలుగా డ్రాగ్ చేసి మరియు డ్రాప్ చేయండి.',style2);
   var question_instructs1 = game.add.text(425, 35, '2. అప్పుడు, సమూహాల మధ్య కేకులను సమానంగా పంచండి.', style2);
   answer_text1 = game.add.text(22, 552, 'సమూహం ఎ: ', style);
   answer_text2 = game.add.text(220,552, 'సమూహం బి : ', style);
   for(var i=0;i<2;i++)
   {
    packets_text = game.add.text(160 + (i*195),552, 'కేకు.',style);
   }
   ...
   instruction_text = game.add.text(19,380,'మీ జవాబులని పూర్ణ సంఖ్యలు లేదా భిన్నాల రూపంలో నమోదు చేయండి మరియు మీ జవాబు సరైందోకాదో చూసుకొనుటకు                       క్లిక్ చేయండి.',style2);
  ...
  var instruction_text1 = game.add.text(91,441, 'పంచుట అయినది ',style3);
  ...
  help_button.events.onInputDown.add(this.help_function,this);
   input_answer1 = game.add.inputField(85, 545, {
    ...
    input_answer2 = game.add.inputField(285, 545, {
    font: '12px Arial',
    fill: '#212121',
    fontWeight: 'bold',
    width: 45,
 ...
 var answerScreen = function(game){}
    answerScreen.prototype =
    {
      ...
      create : function()
      {
       ...
       var text1 = game.add.text(20,25,'2 సమాన సమూహాలలో 12 కేకులను సమానంగా ఏ  విధంగా పంచుతారు.',style);

       text1.wordWrap = true;
       text1.wordWrapWidth = 800;
       var style2 = { font: "italic 14px tahoma", fill: "#4169E1", boundsAlignH: "center", boundsAlignV: "middle" };
       var text2 = game.add.text(20,45,'ఈ కార్యకలాపంలో తరువాతి ప్రశ్నకు వెళ్ళడానికి తరువాత క్లిక్  చేయండి.',style2);
  ...
  var playGame2 = function(game){}
    playGame2.prototype =
    {
      ...
      create : function()
      {
       ...
       var text1 = game.add.text(150,20,'ఒక్కో సమూహం యొక్క వాటాని కనుగొనడంలో జమునికి సహాయం చేయండి.',style);
       ...
       var text2 = game.add.text(22,535,'మీ జవాబుని పూర్ణ సంఖ్య లేదా భిన్నం రూపంలో నమోదు చేయండి మరియు మీ జవాబు సరైందో కాదో చూసుకొనుటకు                     క్లిక్ చేయండి.',style1);
       var text3 = game.add.text(22,570, 'ఒక్కో సమూహం వాటా మొత్తం కేకులలో  ',style);
       var text4 = game.add.text(540,535,' జవాబు నమోదు',style2);
       input_answer3 = game.add.inputField(230, 565, {
    font: '11px Arial',
    fill: '#212121',
    fontWeight: 'bold',
    width: 50,
    ...
    borderRadius: 6,
       ...
       var text4 = game.add.text(320, 570, 'భాగం.',style);
