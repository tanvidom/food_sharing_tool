...
var buttons_down = ['1_MOUSE_DOWN','2_MOUSE_DOWN','3_MOUSE_DOWN','4_MOUSE_DOWN','5_MOUSE_DOWN','6_MOUSE_DOWN'];
 ...
 playGame.prototype = 
 {
  ...
  create : function()
  {
    ...
    question_text_upper = game.add.text(50,8,'సమూహం-ఎ లో లాగా అదే వాటా పొందడానికి సమూహం-బి లో పనివారికి ఎన్ని పరాటాలు తప్పక ఇవ్వాలో లెక్కించడానికి జమునికి సహాయపడండి.',style);
    ...
    var instruction_text2 = game.add.text(110,28,"1. గరిష్టంగా ముడు ఉప-సమూహాలుగా సమూహం బిని విభజించడానికి గ్రూపింగ్ టూల్ ఉపయోగించండి.",style2);
    ...
    //question text
    question_text_lower = game.add.text(22,552,'సమూహం-బి లో9మంది పనివారికి ఎన్ని పరాటాలు అవసరమవుతాయి?',style);
     instruction_text_lower = game.add.text(22,574,'మీ జవాబుని ఒక పూర్ణ సంఖ్య లేదా ఒక భిన్నం రూపంలో నమోదు చేయండి మరియు మీ జవాబు సరైందో కాదో చూసుకొనుటకు పంచుట అయినది క్లిక్ చేయండి.',style2);
...
reset_function : function()
  ...
  create : function()
  {
    ...
    var style = { font: "12px tahoma", fill: "ffff", boundsAlignH: "center", boundsAlignV: "middle" };
    question_text_upper = game.add.text(93,7,'జముని మరియు ఆమె స్నేహితులు అదే రకమైన సమస్యని సాధించడానికి ప్రయత్నిస్తున్నారు.సమూహం-ఎ లో3 (ముగ్గురు)పనివారికి4పరాటాలు సరిపోతాయి,సమూహం-బి లో9మంది పనివారికి సమూహం-ఎ లో లేదా సమాన వాటా పొందడానికి వారికి ఎన్ని పరాటాలు అవసరమవుతాయి?',style);
    question_text_upper.wordWrap = true;
